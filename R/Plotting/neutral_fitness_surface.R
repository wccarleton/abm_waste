...
for(j in 1:6){
   ...
   neutral_adults <- nl.env$agent_neutral[adults]
   plot(y=W_adults,
         x=neutral_adults,
         pch=20,
...
###
mtext("Neutral",font=2,outer=T,side=1,line=2)
mtext("N. Adult Offspring",font=2,outer=T,side=2,line=2)
mtext("Neutral Selection",font=2,outer=T,side=3)

dev.copy(png,file="../Images/neutral_selection.png",width=1500,height=1200,units="px",res=200)
dev.off()
